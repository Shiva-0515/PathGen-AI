...
//   // ------------------------------------------------------------------
//   // CREATE NODES + CONNECT PARENTS TO CHILDREN + CONNECT DAYS
//   // ------------------------------------------------------------------
//   const createNodes = (data) => {
//     const newNodes = [];
//     const newEdges = [];
...
//       if (dayIndex > 0) {
//         newEdges.push({
//           id: `day-edge-${dayIndex}`,
//           source: `day-${dayIndex - 1}`,
//           target: parentId,
//           type: "smoothstep",
//           animated: true,
...
//       // -------------------------
//       // CHILD NODES (Concepts)
//       // -------------------------
//       item.concepts.forEach((concept, childIndex) => {
//         const childId = `day-${dayIndex}-child-${childIndex}`;
...
//             ),
//           },
//           position: { x: 500, y: yOffset + childIndex * 120 },
//           style: {
//             background: "#00bcd4",
//             color: "white",
//             borderRadius: "10px",
...
//   // ------------------------------------------------------------------
//   // CLICK HANDLER - DAY OR CONCEPT
//   // ------------------------------------------------------------------
//   const onNodeClick = (_, node) => {
//     const id = node.id;

//     if (id.startsWith("day-") && !id.includes("child")) {
//       const dayIndex = parseInt(id.split("-")[1]);
//       setSelectedNode(fullData[dayIndex]);
//     } else if (id.includes("child")) {
//       const parts = id.split("-");
//       const dayIndex = parseInt(parts[1]);
//       const childIndex = parseInt(parts[3]);
//       setSelectedNode(fullData[dayIndex].concepts[childIndex]);
//     }
//   };
...
//         {/* ReactFlow Area */}
//         {nodes.length > 0 && (
//           <div style={{ height: 650, background: "#121212", padding: 16, borderRadius: 8 }}>
//             <ReactFlow
//               nodes={nodes}
//               edges={edges}
//               onNodesChange={onNodesChange}
...
//                     {selectedNode.day ? `Day ${selectedNode.day}` : selectedNode.name}
//                   </h2>
//                   <button onClick={() => setSelectedNode(null)}>✕</button>
//                 </div>

//                 <div className="text-sm text-gray-300 overflow-y-auto h-[85%] space-y-2">
...
//                         <div className="text-gray-500">{selectedNode.description}</div>
//                       </>
//                     )
//                   }
//                 </div>
